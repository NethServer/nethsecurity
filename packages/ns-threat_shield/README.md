...
- a merged feed catalog is generated by combining builtin adblock feeds with the available Threat Shield community and enterprise sources
- all DNS queries are redirected to the local machine
- adblock is configured to use the generated merged catalog and will be started
